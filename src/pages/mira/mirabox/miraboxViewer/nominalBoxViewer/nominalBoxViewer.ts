...
export class NominalBoxViewer {
  ...
  constructor(private platformProvider: PlatformProvider,
    ...
    this.getBchAddress();
    this.updateStatus();
    this.ethAccount = this.miraBox.getEthereumPair().address;
    this.ethPrivateKey = this.miraBox.getEthereumPair().privateKey;
  }
